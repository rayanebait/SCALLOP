...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_1000000 = Integer(1000000); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_100000 = Integer(100000)
...
initial_nb_primes=_sage_const_2 
max_nb_primes=_sage_const_4 
