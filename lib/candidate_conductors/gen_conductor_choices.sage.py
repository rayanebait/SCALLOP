...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_1000000 = Integer(1000000); _sage_const_0 = Integer(0); _sage_const_25 = Integer(25); _sage_const_26 = Integer(26); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_50000 = Integer(50000)
...
while nb_primes<max_nb_primes:
	...
	gen_candidates(K, p_above, p_above_conj, stop=_sage_const_50000 )
	print(split_primes)
