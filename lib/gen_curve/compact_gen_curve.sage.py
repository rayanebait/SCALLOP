...
# This file was *autogenerated* from the file compact_gen_curve.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10)
...
"""
def compute_initial_orientation_l(			E0, primes, alpha1,			alpha2,trace, norm,			seq,			keep_factors=False, testing=False):
	...
	for (l, pmone) in zip(primes, seq):
		...
		gen=K1.primes_above(l)[ind].gens_two()[_sage_const_1 ]
	...
	if seq[_sage_const_0 ]==-_sage_const_1 :
		ind=_sage_const_1 
	else:
		ind=_sage_const_0 
...
if testing:
	w_0=compute_initial_orientation_l(			E0, primes,			alpha1, alpha2,			trace, norm,			seq,			testing=testing)
	print(f"Computed initial orientation: {w_0}\n")
	exit(_sage_const_0 )
else:
	s_0=compute_initial_orientation_l(			E0, primes,			alpha1, alpha2,			trace, norm, seq,			keep_factors=False)
...
if nb_primes==_sage_const_0 :
	...
	s=[endo[_sage_const_0 ]*P+endo[_sage_const_1 ]*(iota(P)) for P in s_0]
...
for phi_i in isogs:
	...
	if CheckTrace(Ei, w_Ei, trace)==_sage_const_1 :
		w=w_Ei
		E_l=phi_i.codomain()
		break
