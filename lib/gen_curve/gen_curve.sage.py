...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_1728 = Integer(1728); _sage_const_4 = Integer(4); _sage_const_10 = Integer(10)
...
def gen_isogs_small(E0, primes, alpha1,				alpha2, trace, norm,				l0, h,				intermediate_stop=_sage_const_0 ):
		...
		while step < h-_sage_const_1 :
			...
			if init:
				if step==_sage_const_0 :
					...
					if path[step-_sage_const_1 ]==isog.dual():
						if path_base_l0_plus_1[step]==base-_sage_const_1 :
							"""
							...
							path_base_l0_plus1[step]+=_sage_const_1 
							isog=l0_isogs[								path_base_l0_plus_1[step]								]
							path.append(isog)
					else:
						path.append(isog)
	...
	def add_isogs(base, path, testing=False):
		nonlocal E, E_to_l0_isogs,			nb_isogs, j_path,			h, step
	...
	while go_to_depth(l0+_sage_const_1 , h, path_base_l0_plus_1, init=True, testing=True):
		done=go_back(l0+_sage_const_1 ,h,intermediate_stop)
		continue

	#Petit problème, calcul l0+1 fois la même chose avant de changer
	while not done:
		if go_to_depth(l0+_sage_const_1 , h, path_base_l0_plus_1,			init=False, testing=True):
