...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_13 = Integer(13); _sage_const_4 = Integer(4)
...
print(factor(norm))
print(p)
print(f"p%{_sage_const_5 }={p%_sage_const_5 }, p%{_sage_const_13 }={p%_sage_const_13 }\n")
