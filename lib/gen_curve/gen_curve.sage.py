...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100)
...
def brute_force_orientation_small(E0, primes, alpha1,				alpha2, trace, norm,				l_0, h, l0_h_isogs=[],				path=[], path_base_l0_plus_1=[],				step=_sage_const_0 , E_to_l0_isogs={},				intermediate_stop=_sage_const_100 ):

	def go_to_depth(h, path,		path_base_l0_plus_1,		step, E_to_l0_isogs,		E=E0, init=False):
	...
	def add_isogs(base, path,		E, l0_h_isogs,		E_to_l0_isogs,		nb_isogs):
	...
	def go_back(base, h, step,		path_base_l0_plus_1,
	...
	E=E0
	go_to_depth(h, path,		path_base_l0_plus_1,		step, E_to_l0_isogs, init=True)

	done=False

	nb_isogs=_sage_const_0 
	while not done:
		go_to_depth(h, path,			path_base_l0_plus_1,			step, E_to_l0_isogs,			E=E)

		add_isogs(l_0+_sage_const_1 ,path,			E, l0_h_isogs,			E_to_l0_isogs,			nb_isogs)
		
		done=go_back(h, step,			path_base_l0_plus_1,			intermediate_stop)
...
isogs=brute_force_orientation_small(E0, primes, alpha1,				alpha2, trace, norm,				l_0, h, path_base_l0_plus_1=[_sage_const_0 ]*h,				intermediate_stop=nb_samples)
