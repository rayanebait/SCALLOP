...
def brute_force_orientation_small(E0, primes, alpha1,				alpha2, trace, norm,				l0, h,				intermediate_stop=_sage_const_100 ):
	...
	while not done:
		go_to_depth(h, path_base_l0_plus_1,			init=False)

		add_isogs(l0+_sage_const_1 , path)
		if args.verbose:
