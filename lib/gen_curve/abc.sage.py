...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_1050 = Integer(1050); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_2627 = Integer(2627); _sage_const_3170 = Integer(3170); _sage_const_8833 = Integer(8833); _sage_const_4122 = Integer(4122)
...
sqrt_5=square_root_mod_prime(Mod(-_sage_const_1 , _sage_const_5 ), p=_sage_const_5 )
...
"""
WARNING! GOT STUCK A LONG TIME BECAUSE IT COULD BECAUSE THE l or l_bar/ 5 or 5_bar 
